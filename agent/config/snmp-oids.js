const SNMP_OIDS = {
  system: { description: '1.3.6.1.2.1.1.1.0', uptime: '1.3.6.1.2.1.1.3.0', name: '1.3.6.1.2.1.1.5.0', location: '1.3.6.1.2.1.1.6.0' },
  host: { deviceDescr: '1.3.6.1.2.1.25.3.2.1.3' },
  printer: {
    general: { serialNumber: '1.3.6.1.2.1.43.5.1.1.17' },
    marker: { lifeCount: '1.3.6.1.2.1.43.10.2.1.4' },
    supply: { levels: '1.3.6.1.2.1.43.11.1.1.9', maxCapacity: '1.3.6.1.2.1.43.11.1.1.8', description: '1.3.6.1.2.1.43.11.1.1.6', type: '1.3.6.1.2.1.43.11.1.1.5' },
  },
  vendor: {
    ...
    xerox: { serialNumber: '1.3.6.1.4.1.253.8.53.1.1.1', serialNumber2: '1.3.6.1.4.1.253.8.53.1.1.2', serialNumber3: '1.3.6.1.4.1.253.8.51.10.2.1.2', serialNumber4: '1.3.6.1.4.1.253.8.52.1.1.1.1', totalPages: '1.3.6.1.4.1.253.8.53.1.3.1' },
